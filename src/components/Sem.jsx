        ...
        <div className="SemContainer">
            <div className="SemNavigatorContainer">
                <div className="SemNavigator">
                    ...
                    <button className="sem3btn" style={getButtonStyle(3)} onClick={() => setSelectedSemester(3)}>Sem 3</button>
                    <button className="sem4btn" style={getButtonStyle(4)} onClick={() => setSelectedSemester(4)}>Sem 4</button>
                    <button className="sem5tn" style={getButtonStyle(5)} onClick={() => setSelectedSemester(5)}>Sem 5</button>
                    <button className="sem6btn" style={getButtonStyle(6)} onClick={() => setSelectedSemester(6)}>Sem 6</button>
                    <button className="sem7btn" style={getButtonStyle(7)} onClick={() => setSelectedSemester(7)}>Sem 7</button>
                    <button className="sem8btn" style={getButtonStyle(8)} onClick={() => setSelectedSemester(8)}>Sem 8</button>
                </div>
            </div>
